...
import { getFAQs, getVideo } from '@/api/sections';
//= I18n
...
export async function generateMetadata() {
  ...
  return {
    title: `${translations.pagesTitles.websiteName} - ${translations.pagesTitles.faq}`,
...
export default async function TeamPage() {
  ...
  const translations = dictionary.faq.header;
